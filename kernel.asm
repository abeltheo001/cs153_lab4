...
initlock(&(shm_table.lock), "SHM lock");
80106e9a:	c7 44 24 04 14 79 10 	movl   $0x80107914,0x4(%esp)
80106ea1:	80 
80106ea2:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ea9:	e8 b2 d1 ff ff       	call   80104060 <initlock>
acquire(&(shm_table.lock));
80106eae:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106eb5:	e8 96 d2 ff ff       	call   80104150 <acquire>

//check if user input a zero or negative by mistake
if (id <= 0) {
80106eba:	85 db                	test   %ebx,%ebx
80106ebc:	7e 4e                	jle    80106f0c <shm_close+0x7c>
80106ebe:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106ec3:	eb 0d                	jmp    80106ed2 <shm_close+0x42>
80106ec5:	8d 76 00             	lea    0x0(%esi),%esi
80106ec8:	83 c0 0c             	add    $0xc,%eax
}
...
for (i = 0; i < 64; i++) {
80106ecb:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ed0:	74 2e                	je     80106f00 <shm_close+0x70>
	if (shm_table.shm_pages[i].id == id) {	
80106ed2:	39 18                	cmp    %ebx,(%eax)
80106ed4:	75 f2                	jne    80106ec8 <shm_close+0x38>
		if (shm_table.shm_pages[i].refcnt > 0)
80106ed6:	8b 50 08             	mov    0x8(%eax),%edx
80106ed9:	85 d2                	test   %edx,%edx
80106edb:	7e 06                	jle    80106ee3 <shm_close+0x53>
			shm_table.shm_pages[i].refcnt--;
80106edd:	83 ea 01             	sub    $0x1,%edx
80106ee0:	89 50 08             	mov    %edx,0x8(%eax)

		if (shm_table.shm_pages[i].refcnt == 0) {
80106ee3:	85 d2                	test   %edx,%edx
80106ee5:	75 e1                	jne    80106ec8 <shm_close+0x38>
			shm_table.shm_pages[i].id = 0;
80106ee7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106eed:	83 c0 0c             	add    $0xc,%eax
			shm_table.shm_pages[i].frame = 0;
80106ef0:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
for (i = 0; i < 64; i++) {
80106ef7:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106efc:	75 d4                	jne    80106ed2 <shm_close+0x42>
