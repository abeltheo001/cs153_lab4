...
80106dd7:	eb 12                	jmp    80106deb <shm_open+0xfb>
...
80106de9:	74 6d                	je     80106e58 <shm_open+0x168>
    if (shm_table.shm_pages[i].id == 0) {
80106deb:	8b 0a                	mov    (%edx),%ecx
80106ded:	85 c9                	test   %ecx,%ecx
80106def:	75 ef                	jne    80106de0 <shm_open+0xf0>
      shm_table.shm_pages[i].id = id;
80106df1:	8d 34 40             	lea    (%eax,%eax,2),%esi
80106df4:	c1 e6 02             	shl    $0x2,%esi
80106df7:	89 9e f4 54 11 80    	mov    %ebx,-0x7feeab0c(%esi)
      shm_table.shm_pages[i].frame = kalloc();
80106dfd:	e8 ae b6 ff ff       	call   801024b0 <kalloc>
      shm_table.shm_pages[i].refcnt = 1;
80106e02:	c7 86 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%esi)
80106e09:	00 00 00 
      shm_table.shm_pages[i].frame = kalloc();
80106e0c:	89 86 f8 54 11 80    	mov    %eax,-0x7feeab08(%esi)
      mappages(myproc()->pgdir, (void *)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106e12:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
80106e18:	e8 93 c8 ff ff       	call   801036b0 <myproc>
80106e1d:	8b 18                	mov    (%eax),%ebx
80106e1f:	e8 8c c8 ff ff       	call   801036b0 <myproc>
80106e24:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e2b:	00 
80106e2c:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106e30:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
80106e36:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106e3c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e43:	00 
80106e44:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106e48:	8b 40 04             	mov    0x4(%eax),%eax
80106e4b:	89 04 24             	mov    %eax,(%esp)
80106e4e:	e8 fd f6 ff ff       	call   80106550 <mappages>
80106e53:	e9 27 ff ff ff       	jmp    80106d7f <shm_open+0x8f>
  release(&(shm_table.lock));
80106e58:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e5f:	e8 dc d3 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning - you should decide what to return
80106e64:	e9 5a ff ff ff       	jmp    80106dc3 <shm_open+0xd3>
...
if (id <= 0) {
80106e9a:	85 db                	test   %ebx,%ebx
80106e9c:	7e 4e                	jle    80106eec <shm_close+0x7c>
80106e9e:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106ea3:	eb 0d                	jmp    80106eb2 <shm_close+0x42>
80106ea5:	8d 76 00             	lea    0x0(%esi),%esi
80106ea8:	83 c0 0c             	add    $0xc,%eax
}
...
for (i = 0; i < 64; i++) {
80106eab:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106eb0:	74 2e                	je     80106ee0 <shm_close+0x70>
	if (shm_table.shm_pages[i].id == id) {	
80106eb2:	39 18                	cmp    %ebx,(%eax)
80106eb4:	75 f2                	jne    80106ea8 <shm_close+0x38>
		if (shm_table.shm_pages[i].refcnt > 0)
80106eb6:	8b 50 08             	mov    0x8(%eax),%edx
80106eb9:	85 d2                	test   %edx,%edx
80106ebb:	7e 06                	jle    80106ec3 <shm_close+0x53>
			shm_table.shm_pages[i].refcnt--;
80106ebd:	83 ea 01             	sub    $0x1,%edx
80106ec0:	89 50 08             	mov    %edx,0x8(%eax)

		if (shm_table.shm_pages[i].refcnt == 0) {
80106ec3:	85 d2                	test   %edx,%edx
80106ec5:	75 e1                	jne    80106ea8 <shm_close+0x38>
			shm_table.shm_pages[i].id = 0;
80106ec7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106ecd:	83 c0 0c             	add    $0xc,%eax
			shm_table.shm_pages[i].frame = 0;
80106ed0:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
for (i = 0; i < 64; i++) {
80106ed7:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106edc:	75 d4                	jne    80106eb2 <shm_close+0x42>
